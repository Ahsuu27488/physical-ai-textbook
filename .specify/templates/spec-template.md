...
- **FR-006**: Implementation MUST follow "No Hallucination of Syntax" principle by using proper documentation sources (Context7, Google Search, etc.) for configuration files
